...
<!-- a script for each subsection -->
<!-- two buttons: copy/paste and download full code for that subsection -->
...
<!-- next four sections -->
<!-- subsection 1: walk through of how you specify a model, using a binary exposure variable with binary outcome (primary) -->
<!-- subsection 2: issues specific to other designs that talk through the general principles listed in each section -->
