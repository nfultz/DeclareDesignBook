...
- Explain declaration -> diagnosis -> redesign process (graphic?)
...
## Kinds of research projects that there are
- Do you want to answer a causal or descriptive question?
- Typology of questions: COE vs EOC for causal; questions about one of the modes of the distribution of a variable; 
...
- Is the answer defined? (include not only missingness, but ATE for categorical outcomes)
...
- inquiries about "regimes" (i.e., vote share at the precinct level.)
