...
The point is that potential outcomes are the building blocks of your inquiry---if you are not interested in the counterfactual differences in an outcome generated by some other variable, then you do not need to worry about the corresponding potential outcomes. But if you want to know a causal effect, you have to model the state of the world when the cause is present and the one in which it is absent. A causal effect is defined as the difference between those two states of the world.
...
What's so important about defining these imaginary potential outcomes? Why do we need all three of these variables, and not just $Y_i$, the values we actually observe? 
