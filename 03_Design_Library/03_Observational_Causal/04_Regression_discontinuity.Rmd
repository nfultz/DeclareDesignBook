...
rds_file_path <- paste0(get_dropbox_path("regression_discontinuity"), "/rd_diagnosis.RDS")
if (do_diagnosis & !exists("do_bookdown")) {
  write_rds(rd_diagnosis, path = rds_file_path)
}
rd_diagnosis <- read_rds(rds_file_path)
```
