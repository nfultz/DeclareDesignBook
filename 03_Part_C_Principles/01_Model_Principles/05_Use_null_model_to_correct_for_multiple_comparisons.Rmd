...
Then, we simulate the design hundreds of times. Every time we see that the $p$-value from one of our tests falls below $\alpha$, we infer (falsely) that there's an effect.  
